...
<head>
    ...
    <title> Sing Up | Learners association of NBICT LAB</title>
...
<body>
    ...
    <section>
        <div class="singup">
            ...
            <div>
                <div class="signup <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                    <p>Username</p>
                ...
                <div class="form-group">
                    <button type="reset" class="button_2">Reset</button>
                    <button type="submit" class="button_2">Submit</button>
                </div>
                <p>Already have an account? <a style="color: #fff" href="login.php">Login here</a>.</p>
            </div>
            </form>
        </div> 
    </section>   
